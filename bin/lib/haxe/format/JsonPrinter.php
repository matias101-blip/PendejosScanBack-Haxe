...
class JsonPrinter {
	...
	public function fieldsString ($v, $fields) {
		...
		$len = $fields->length;
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:168: characters 3-20
		$empty = true;
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:169: characters 13-17
		$_g = 0;
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:169: characters 17-20
		$_g1 = $len;
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:169: lines 169-186
		while ($_g < $_g1) {
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:169: characters 13-20
			$i = $_g++;
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:170: characters 4-22
			$f = ($fields->arr[$i] ?? null);
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:171: characters 4-36
			$value = \Reflect::field($v, $f);
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:172: characters 8-33
			$f1 = $value;
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:172: lines 172-173
			if (($f1 instanceof \Closure) || ($f1 instanceof HxClosure)) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:173: characters 5-13
				continue;
			}
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:174: lines 174-178
			if ($empty) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:175: characters 5-11
				$this->nind++;
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:176: characters 5-18
				$empty = false;
			} else {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:178: characters 5-22
				$_this = $this->buf;
				$_this->b = ($_this->b??'null') . (\mb_chr(44)??'null');
			}
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:179: characters 4-10
			if ($this->pretty) {
				$_this1 = $this->buf;
			...
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:181: characters 4-12
			$this->quote($f);
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:182: characters 4-21
			$_this2 = $this->buf;
			$_this2->b = ($_this2->b??'null') . (\mb_chr(58)??'null');
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:183: lines 183-184
			if ($this->pretty) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:184: characters 5-22
				$_this3 = $this->buf;
				$_this3->b = ($_this3->b??'null') . (\mb_chr(32)??'null');
			}
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:185: characters 4-19
			$this->write($f, $value);
		}
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:187: lines 187-191
		if (!$empty) {
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:188: characters 4-10
			$this->nind--;
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:189: characters 4-10
			if ($this->pretty) {
				$_this = $this->buf;
				$_this->b = ($_this->b??'null') . (\mb_chr(10)??'null');
			}
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:190: characters 4-10
			if ($this->pretty) {
				$v = \StringTools::lpad("", $this->indent, $this->nind * mb_strlen($this->indent));
				$this->buf->add($v);
			}
		}
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:192: characters 3-20
		$_this = $this->buf;
	...
	public function quote ($s) {
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:202: characters 3-20
		$_this = $this->buf;
		$_this->b = ($_this->b??'null') . (\mb_chr(34)??'null');
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:203: characters 3-13
		$i = 0;
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:204: characters 3-25
		$length = mb_strlen($s);
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:208: lines 208-250
		while ($i < $length) {
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:209: characters 4-45
			$c = \StringTools::unsafeCodeAt($s, $i++);
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:210: lines 210-249
			if ($c === 8) {
				...
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:216: characters 6-16
				$this->buf->add("\\n");
			} else if ($c === 12) {
				...
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:212: characters 6-16
				$this->buf->add("\\\"");
			} else if ($c === 92) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:214: characters 6-17
				$this->buf->add("\\\\");
			} else {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:247: characters 6-16
				$_this = $this->buf;
				$_this->b = ($_this->b??'null') . (\mb_chr($c)??'null');
			}
		}
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:255: characters 3-20
		$_this = $this->buf;
		$_this->b = ($_this->b??'null') . (\mb_chr(34)??'null');
	}
	...
	public function write ($k, $v) {
		...
		if ($__hx__switch === 0) {
			...
			$_g1 = $_g->params[0];
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:131: characters 5-31
			$i = $v->index;
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:132: characters 5-23
			$v = \Std::string($i);
			$this->buf->add($v);
