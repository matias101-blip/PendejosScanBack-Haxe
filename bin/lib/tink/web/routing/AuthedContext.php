...
class AuthedContext extends Context {
	...
	public function __construct ($parent, $accepts, $request, $depth, $parts, $params, $session, $user = null) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Context.hx:179: characters 5-27
		$this->session = $session;
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Context.hx:180: lines 180-184
		$tmp = null;
		if ($user === null) {
			#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Context.hx:182: characters 9-53
			$this1 = $session;
			$f = function ($s) {
				#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Context.hx:182: characters 34-52
				return $s->getUser();
			};
			#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Context.hx:180: lines 180-184
			...
			#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Context.hx:183: characters 12-13
			$v = $user;
			#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Context.hx:180: lines 180-184
			$tmp = $v;
		}
		$this->user = $tmp;
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Context.hx:186: characters 5-58
	...
	public function sub ($descend) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Context.hx:190: characters 5-100
