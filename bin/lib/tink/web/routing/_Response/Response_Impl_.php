...
final class Response_Impl_ {
	...
	public static function binary ($code, $contentType, $bytes, $headers = null) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:50: characters 5-68
		if ($code === null) {
			$code = 200;
		}
	...
	public static function empty ($code = 200) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:54: characters 5-117
		if ($code === null) {
			$code = 200;
		}
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:54: characters 58-62
		$this1 = HttpStatusMessage_Impl_::fromCode($code);
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:54: characters 33-103
		$this2 = new ResponseHeaderBase($code, $this1, \Array_hx::wrap([new HeaderField("content-length", "0")]), "HTTP/1.1");
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:54: characters 12-117
	...
	public static function fromChunk ($c) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:25: characters 5-22
	...
	public static function fromIdealSource ($source) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:37: characters 5-33
	...
	public static function fromRealSource ($source) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:34: characters 5-74
		return Response_Impl_::ofRealSource(RealSourceTools::idealize($source, function ($_) {
			#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:34: characters 53-72
	...
	public static function ofBytes ($b) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:22: characters 5-29
	...
	public static function ofChunk ($c, $contentType = "application/octet-stream") {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:16: characters 5-40
		if ($contentType === null) {
	...
	public static function ofIdealSource ($source, $contentType = "application/octet-stream") {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:31: characters 5-114
		if ($contentType === null) {
			$contentType = "application/octet-stream";
		}
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:31: characters 56-58
		$this1 = HttpStatusMessage_Impl_::fromCode(200);
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:31: characters 12-114
	...
	public static function ofRealSource ($source, $contentType = "application/octet-stream") {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:28: characters 5-156
		if ($contentType === null) {
			$contentType = "application/octet-stream";
		}
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:28: characters 56-58
		$this1 = HttpStatusMessage_Impl_::fromCode(200);
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:28: characters 33-105
		$this2 = new ResponseHeaderBase(200, $this1, \Array_hx::wrap([new HeaderField("content-type", $contentType)]), "HTTP/1.1");
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:28: characters 12-156
		return new OutgoingResponseData($this2, RealSourceTools::idealize($source, function ($_) {
			#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:28: characters 135-154
			return Source_Impl_::$EMPTY;
		}));
	}
	...
	public static function ofString ($s) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:19: characters 5-36
	...
	public static function ofUrl ($u) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:45: characters 59-64
		$this1 = HttpStatusMessage_Impl_::fromCode(302);
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:45: characters 84-92
		$this2 = \mb_strtolower("location");
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:45: characters 33-99
		$this3 = new ResponseHeaderBase(302, $this1, \Array_hx::wrap([new HeaderField($this2, Url_Impl_::toString($u))]), "HTTP/1.1");
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:45: characters 12-113
	...
	public static function textual ($code, $contentType, $string, $headers = null) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:58: characters 5-70
		if ($code === null) {
			$code = 200;
		}
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:58: characters 38-60
		$tmp = \strlen($string);
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/routing/Response.hx:58: characters 5-70
