		...
		if ($_g === "GET") {
			...
			if ($l > 0) {
				...
				if ($_g1 === "api") {
					...
					if ($_g5 === true) {
						if ($_g6 === true) {
							if ($_g7 === false) {
								...
								$capitulo = $_g3;
								$nombre = $_g2;
								#src/Server.hx:89: characters 11-34
						...
						if ($_g6 === true) {
							if ($_g7) {
								if ($_g8 === false) {
									...
									$capitulo = $_g3;
									$pag = $_g4;
									#src/Server.hx:50: characters 11-40
								...
								$portada = $_g3;
								$nombre = $_g2;
								#src/Server.hx:49: characters 11-34
					...
					#/home/thehunter101/haxe/tink_web/0,3,0/src/tink/web/macros/Routing.hx:136: characters 22-31
					if ($_g5 === false) {
						#src/Server.hx:44: characters 11-23
