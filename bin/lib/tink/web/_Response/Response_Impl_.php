...
final class Response_Impl_ {
	...
	public static function _new ($header, $body) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/Response.hx:10: character 2
	...
	public static function getData ($this1) {
		#/home/sinherani/haxelib/tink_web/0,3,0/src/tink/web/Response.hx:15: characters 3-19
		return $this1->body;
	}
}
