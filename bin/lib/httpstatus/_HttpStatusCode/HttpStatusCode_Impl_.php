...
final class HttpStatusCode_Impl_ {
	...
	public static function fromErrorCode ($code) {
		#/home/sinherani/haxelib/http-status/1,3,1/src/httpstatus/HttpStatusCode.hx:87: characters 3-20
		return $code;
	}
	...
	public static function fromIncomingResponse ($res) {
		#/home/sinherani/haxelib/http-status/1,3,1/src/httpstatus/HttpStatusCode.hx:105: characters 3-31
	...
	public static function toInt ($this1) {
		#/home/sinherani/haxelib/http-status/1,3,1/src/httpstatus/HttpStatusCode.hx:74: characters 3-14
		return $this1;
	}
	...
	public static function toMessage ($this1) {
		#/home/sinherani/haxelib/http-status/1,3,1/src/httpstatus/HttpStatusCode.hx:70: characters 10-37
	...
	public static function toOutgoingResponse ($this1) {
		#/home/sinherani/haxelib/http-status/1,3,1/src/httpstatus/HttpStatusCode.hx:100: characters 51-62
		$this2 = HttpStatusMessage_Impl_::fromCode($this1);
		#/home/sinherani/haxelib/http-status/1,3,1/src/httpstatus/HttpStatusCode.hx:100: characters 4-120
		$this3 = new ResponseHeaderBase($this1, $this2, \Array_hx::wrap([new HeaderField("content-length", "0")]), "HTTP/1.1");
		#/home/sinherani/haxelib/http-status/1,3,1/src/httpstatus/HttpStatusCode.hx:99: lines 99-102
	...
	public static function toWebResponse ($this1) {
		#/home/sinherani/haxelib/http-status/1,3,1/src/httpstatus/HttpStatusCode.hx:93: characters 3-30
