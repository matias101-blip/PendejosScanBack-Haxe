...
class Std {
	...
	public static function parseInt ($x) {
		#/usr/share/haxe/std/php/_std/Std.hx:55: characters 3-41
		$x = ltrim($x, " \x09\x0A\x0B\x0C\x0D");
		#/usr/share/haxe/std/php/_std/Std.hx:56: characters 3-44
		$digitsOnly = ltrim($x, "+-");
		#/usr/share/haxe/std/php/_std/Std.hx:57: lines 57-63
		if (str_starts_with($digitsOnly, "0x") || str_starts_with($digitsOnly, "0X")) {
			#/usr/share/haxe/std/php/_std/Std.hx:58: characters 4-37
			$val = intval($x, 16);
			#/usr/share/haxe/std/php/_std/Std.hx:60: lines 60-61
			if (($val === 0) && ((mb_strlen($digitsOnly) + 1) < mb_strlen($x))) {
				#/usr/share/haxe/std/php/_std/Std.hx:61: characters 5-16
				return null;
			}
			#/usr/share/haxe/std/php/_std/Std.hx:62: characters 4-14
			return $val;
		}
		#/usr/share/haxe/std/php/_std/Std.hx:65: characters 10-32
		$_g = stripos($x, "e");
		if ($_g !== false) {
			#/usr/share/haxe/std/php/_std/Std.hx:67: characters 9-13
			$ePos = $_g;
			#/usr/share/haxe/std/php/_std/Std.hx:67: characters 15-44
			$x = substr($x, 0, $ePos);
		}
		#/usr/share/haxe/std/php/_std/Std.hx:70: characters 3-36
		$val = intval($x, 10);
		#/usr/share/haxe/std/php/_std/Std.hx:73: lines 73-74
		if (($val === 0) && ((strspn($digitsOnly, "0123456789", 0, 1) === 0) || ((mb_strlen($digitsOnly) + 1) < mb_strlen($x)))) {
			#/usr/share/haxe/std/php/_std/Std.hx:74: characters 4-15
			return null;
		}
		#/usr/share/haxe/std/php/_std/Std.hx:75: characters 3-13
		return $val;
	}
