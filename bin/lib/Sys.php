...
class Sys {
	...
	public static function systemName () {
		#/usr/share/haxe/std/php/_std/Sys.hx:121: characters 3-33
		$s = php_uname("s");
		#/usr/share/haxe/std/php/_std/Sys.hx:122: characters 3-26
		$p = HxString::indexOf($s, " ");
		#/usr/share/haxe/std/php/_std/Sys.hx:123: characters 10-39
		if ($p >= 0) {
			#/usr/share/haxe/std/php/_std/Sys.hx:123: characters 20-34
			return mb_substr($s, 0, $p);
		} else {
			#/usr/share/haxe/std/php/_std/Sys.hx:123: characters 37-38
			return $s;
		}
	}
}
