...
class Server {
	...
	public static function main () {
		#src/Server.hx:30: characters 9-56
		header("Access-Control-Allow-Origin: *");
		#src/Server.hx:31: characters 9-74
		header("Access-Control-Allow-Methods: GET, POST, OPTIONS");
		#src/Server.hx:32: characters 9-83
		header("Access-Control-Allow-Headers: Content-Type, Authorization");
		#src/Server.hx:33: characters 9-43
		$container = PhpContainer::$inst;
		#src/Server.hx:34: characters 9-51
		$router = new Router0(new \Root());
		#src/Server.hx:35: lines 35-38
		$container->run(new SimpleHandler(function ($req) use (&$router) {
			#src/Server.hx:36: lines 36-37
